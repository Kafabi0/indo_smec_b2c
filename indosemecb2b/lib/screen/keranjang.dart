...
class CartScreenState extends State<CartScreen> with RouteAware {
  ...
  showDialog(
    ...
    builder: (context) => Dialog(
      backgroundColor: Colors.transparent, // ✅ Biar background bisa custom
      elevation: 0,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // ✅ LIST PRODUK DENGAN SCROLL (jika banyak)
                  ConstrainedBox(
                    constraints: const BoxConstraints(maxHeight: 300),
                    child: SingleChildScrollView(
                      child: Column(
                        children: itemsBelowMinimum.map((item) {
                          return Container(
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Tambahkan jumlah produk agar memenuhi minimum pembelian',
                            style: TextStyle(
                              fontSize: 12,
